                                                ...
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-2 border-t border-white/5 mt-1">
                                                    ...
                                                    {(patch.description || patch.summary) && (
                                                        <div className="md:col-span-2">
                                                            ...
                                                            <p className="text-xs font-mono text-emerald-300/80 max-w-full truncate" title={patch.description || patch.summary}>{patch.description || patch.summary}</p>
                                                        </div>
                                                    )}
                                                </div>

                                                {(patch.description || patch.diff_content || patch.Description) && (
                                                    <div className="mt-1">
