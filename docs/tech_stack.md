...
- 데이터베이스 트랜잭션 및 파이프라인 외부 스크립트 트리거 처리
...
### 3. AI Interruption (Optional / Local LLM)
- `OpenClaw`와 같은 로컬 기반 또는 폐쇄망 API 호출 구조
- JSON의 Context를 주입받아 Markdown/Korean 형태로 렌더링 된 Result 반환
