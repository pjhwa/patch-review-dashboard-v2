...
Before each AI invocation, `query_rag.py` retrieves historically excluded patch entries and injects them as hard exclusion rules into the AI prompt. This prevents re-recommending patches that operations team has already reviewed and declined.
