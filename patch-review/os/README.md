...
| **Windows** | *Under development. Will follow the identical Automated Pipeline.* | *TBD* |
| **Unix** | *Under development. Will follow the identical Automated Pipeline.* | *TBD* |

> **Note**: While specific LLM prompt instructions (SKILL.md) for Windows, HP-UX, AIX, and Solaris are currently under development, they will strictly enforce the exact same **Automated Pipeline** and **LLM Review Procedure** established for Linux. 
