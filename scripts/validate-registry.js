...
const PRODUCTS = [
    { id: 'redhat',    skillDirRelative: 'os/linux-v2',           preprocessingScript: 'patch_preprocessing.py',   jobName: 'run-redhat-pipeline',    rateLimitFlag: '/tmp/.rate_limit_redhat',    passthrough: true,  ragType: 'prompt-injection', queryScript: 'query_rag.py' },
    { id: 'oracle',    skillDirRelative: 'os/linux-v2',           preprocessingScript: 'patch_preprocessing.py',   jobName: 'run-oracle-pipeline',    rateLimitFlag: '/tmp/.rate_limit_oracle',    passthrough: true,  ragType: 'prompt-injection', queryScript: 'query_rag.py' },
    { id: 'ubuntu',    skillDirRelative: 'os/linux-v2',           preprocessingScript: 'patch_preprocessing.py',   jobName: 'run-ubuntu-pipeline',    rateLimitFlag: '/tmp/.rate_limit_ubuntu',    passthrough: true,  ragType: 'prompt-injection', queryScript: 'query_rag.py' },
